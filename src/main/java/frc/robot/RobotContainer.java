...
public class RobotContainer {
        ...
        private final SwerveRequest.FieldCentric drive = new SwerveRequest.FieldCentric()
                        .withDeadband(MaxSpeed * 0.1).withRotationalDeadband(MaxAngularRate * 0.05) // Add a 10%
                                                                                                    // deadband
        ...
        private void configureBindings() {
                ...
                drivetrain.setDefaultCommand(
                                ...
                                drivetrain.applyRequest(
                                                () -> drive.withVelocityX(ForwardFilter
                                                                .calculate(-joystick.getLeftY() * MaxSpeed)) // Drive
                                                                                                             // forward
                                                                                                             // with
                                                                                                             // negative
                                                                                                             // Y
                                                                                                             // (forward)
                                                                .withVelocityY(TurnFilter.calculate(
                                                                                -joystick.getLeftX() * MaxSpeed)) // Drive
                                                                                                                  ...
                                                                                                                  // X
                                                                                                                  // (left)
                                                                .withRotationalRate(RotateFilter.calculate(
