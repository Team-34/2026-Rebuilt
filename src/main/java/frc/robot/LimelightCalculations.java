...
public class LimelightCalculations {
    ...
    /**
     * Returns the distance to a tag by utilizing the
     * TZ value from a LimelightHelpers array, and multiplying 
     * it by a constant value (of 65) to convert it to inches.
    ...
    public static double getDistanceToTarget() {
        ...
        return targpose_camspace[tzIndex] * tzToInchesScalar;
